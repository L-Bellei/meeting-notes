...
- **Textos datados restantes em `frontend/src/App.tsx` sobre chave de API** — sobrevivem à migração para provider único: o comentário "Check 3 — Chave da API" e o fallback "Chave inválida. Verifique nas configurações." não refletem mais o fluxo de subscription/token OAuth.
